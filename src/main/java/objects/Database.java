...
class DB_exp {
    public static String db_file = new File("./database.json").getAbsolutePath();
    static modules.Logger logger = new Logger("Database");
...
public class Database extends DB_exp {
    ...
    public void save(){
        ...
        write(db_file, DB_defaults.load_user(instance));
    }
