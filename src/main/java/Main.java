...
public class Main{
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("NastU Running...");
    ...
    public static void run() throws Exception {
        ...
        try {
            ...
            System.out.println("Не удалось подключиться к хосту "+exception.getMessage());
            System.out.println("Возможно, у вас нет подключения к Интернету");
        }
    }
}
